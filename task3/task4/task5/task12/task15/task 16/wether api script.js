...
async function getCountries() {
  ...
  for (getCountries of data) {
    ...
    div_6.innerHTML = `Capital: <span>${getCountries?.capital[0]}</span>`;
    const div_7 = document.createElement("div");
    div_7.classList.add("Region");
    div_7.innerHTML = `Region: <span>${getCountries?.region}</span>`;
    const div_8 = document.createElement("div");
    div_8.classList.add("latlng");
    div_8.innerHTML = `LatLng: <span>${getCountries?.latlng[0]}, ${getCountries?.latlng[1]} </span>`;
    const div_9 = document.createElement("div");
    div_9.classList.add("country_code");
    div_9.innerHTML = `Country Code: <span>${getCountries?.altSpellings[0]}</span>`;
